package com.tbd.UnNetHack.Hearse;

import android.app.Activity;
import android.content.SharedPreferences;
import android.text.TextUtils;
import android.widget.Toast;
import com.tbd.UnNetHack.Log;
...
public class Hearse implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	private static final String CLIENT_NAME = "Gurr Android UnNethack";
...
//    private static final int HEADER_VERSION_COUNT = 4;
	 ...
	 */
	private static final Pattern PATTERN = Pattern.compile("^bon[A-Z](0|(:?Arc|Bar|Cav|Con|Hea|Kni|Mon|Pri|Rog|Ran|Sam|Tou|Val|Wiz))\\.([A-Z]|\\d+)\\z", Pattern.CASE_INSENSITIVE);
	 ...
	 *
	 * @param context The {@link android.app.Activity} application for access to {@link android.app.Activity}, through which it can
	 *            create {@link android.widget.Toast} notifications, etc.
	...
	private int downloadBones() {
		...
		int nDownloaded = 0;
		String hackver = prefs.getString(HEADER_NETHACKVER, "56"); // 56 is us, 26 is Windows 3.4.3
		...
		while (true) {
			...
			if (header != null) {
				...
				// For thread safety, don't download as real name. UnNethack might try to load it before complete
